...
const TransactionCard = ({ 
    ...
    const labelColor = dataType  === 'expense' ? 'text-red-500' : 'text-lime-500';
    ...
    return (
      <div className="flex justify-between items-center p-4 text-gray-500 bg-white border border-slate-200 rounded-xl shadow-lg">
        ...
        <EditButton label={label} toggleModal={toggleModal} />
        <DeleteButton label={label} type={dataType} fetchData={fetchData}/>                                
    </div>
    );
  }
